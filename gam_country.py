...
report_job = {
      'reportQuery': {
          'dimensions': ['AD_UNIT_ID', 'COUNTRY_NAME'],
...
try: 
  df.to_csv(r'/Users/christian/Documents/Work/gam_api/output_data/gam_country.csv', index=False)
...
dff = pd.read_csv(r'/Users/christian/Documents/Work/gam_api/output_data/gam_country.csv')
...
def copy_from_dataframe(conn, dff):
    ...
    try:
        dff.to_sql('gam_country',conn, if_exists='replace')
