...
report_job = {
      'reportQuery': {
          'dimensions': ['AD_UNIT_ID', 'GPR_DEMOGRAPHICS'],
...
try: 
  df.to_csv(r'/Users/christian/Documents/Work/gam_api/output_data/gam_demos.csv', index=False)
...
dff = pd.read_csv(r'/Users/christian/Documents/Work/gam_api/output_data/gam_demos.csv')
...
def copy_from_dataframe(conn, dff):
    ...
    try:
        dff.to_sql('gam_demos',conn, if_exists='replace')
